...
# The goal is to get the agent to create and include a plan for its work at the start of the conversation. 
# For example, for a data analysis task, the agent might generate a plan like this:
